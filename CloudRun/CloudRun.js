// Add your JavaScript logic here
    ...
    //Image NAME
    function ImageName(inputField) {
        var inputValue = inputField.value;
  
        if (inputValue === "") {
          // If empty, display an error message
          document.getElementById("ImageNameError").textContent =
            'Field cannot be empty.';
        } else {
          document.getElementById("ImageNameError").textContent = "";
        }
    ...
    function Ports(inputField) {
      ...
      if (!regex.test(inputValue)) {
        ...
        document.getElementById("PortsError").textContent =
          'Start  Only  0-9, "-" are allowed.';
      } else {
        document.getElementById("PortsError").textContent = "";
      }
    }

    // EnvironmentVariable Input 1
    function EnvironmentVariable1(inputField) {
        var inputValue = inputField.value;
  
        if (inputValue === "") {
          // If empty, display an error message
          document.getElementById("EnvironmentVar1Error").textContent =
            'Field cannot be empty.';
        } else {
          document.getElementById("EnvironmentVar1Error").textContent = "";
        }
      ...
      // EnvironmentVariable Input 1
    function EnvironmentVariable2(inputField) {
        var inputValue = inputField.value;
    ...
    function validateForm() {
      ...
      var Environmentvar1 = document.getElementById("environmentVariable1");
      var Environmentvar2 = document.getElementById("environmentVariable2");
      ...
      ImageName(imageName);
      Ports(PortS);
      EnvironmentVariable1(Environmentvar1);
      EnvironmentVariable2(Environmentvar2);
      ...
      var imageNameError = document.getElementById("ImageNameError").textContent;
      var portsError = document.getElementById("PortsError").textContent;
      var environmentVar1Error = document.getElementById("EnvironmentVar1Error").textContent;
    


      if (RepoNameError.trim() !== "" || PatError.trim() !== "" || RegionError.trim() !== "" || ZoneError.trim() !== "" || nameError.trim() !== "" || imageNameError.trim() !== "" || portsError.trim() !== "" || environmentVar1Error.trim() !== "") {
        return false;
      }
      return true;
    }