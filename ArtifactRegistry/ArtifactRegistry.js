// Add your JavaScript logic here
    ...
    // Repository ID
    function  RepoID(inputField) {
      var regex = /^[a-z][a-z0-9\-]*$/;
      var inputValue = inputField.value;

      if (!regex.test(inputValue)) {
        inputField.value = inputValue.replace(/[^a-z0-9\-]/g, "");
        document.getElementById("repositoryidError").textContent =
    ...
    function validateForm() {
      ...
      var repoID = document.getElementById("repositoryid");
      ...
      var RepositoryIDError = document.getElementById("repositoryidError").textContent;
      var FormatError = document.getElementById("formatError").textContent;



      if (RepoNameError.trim() !== "" || PatError.trim() !== "" || RegionError.trim() !== "" || ZoneError.trim() !== "" || RepositoryIDError.trim() !== "" || FormatError.trim() !== "") {
        return false;
      }
      return true;
    }